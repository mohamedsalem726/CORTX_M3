...
{
	MNVIC_voidEXTIEnControl(Copy_u8Line, MNVIC_ENABLE);	    /* Enables External interrupt for EXTI */
	MEXTI_voidLineEnorDis(Copy_u8Line, MEXTI_ENABLE);		/* Unmask Interrupt request from selected EXTI line(Cpy_u8Line) */
